    ...
    <div class="bg-blue-900 w-200 mx-auto rounded">
            ...
            <form action="{{ route('todo.update', $task->id) }}" method="POST">
                ...
                <div class="bg-blue-900 flex p-2 m-2">
                    ...
                    <input type="text" placeholder="Título" name="title" id="title" value="{{ $task->title }}"class="bg-gray-200 p-2 m-2 flex flex-grow rounded-lg">
                </div>

                <div class="bg-blue-900 min-h-80 p-2 m-2 flex overflow-auto max-h-80">
                    <textarea placeholder="Descrição" name="description" id="description" value="{{ $task->description }}" class="bg-gray-200  p-2 m-2 w-full rounded-lg"></textarea>
                </div>
                ...
                <input type="date" name="due_date" id="due_date" value="{{ $task->due_date }}" class="bg-gray-200 m-1 p-2 rounded-lg">
                ...
                <button class="group relative inline-flex items-center overflow-hidden rounded-lg bg-indigo-600 px-8 py-3 text-white focus:ring-3 focus:outline-hidden">
                    ...
                    <span class="text-sm font-medium transition-all group-hover:me-4"> Atualizar Tarefa </span>
                </button>
